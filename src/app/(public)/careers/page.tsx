          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/careers/jobs">
                <span className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-lg bg-tg-gold text-tg-navy font-bold text-sm hover:bg-yellow-400 transition-all shadow-lg cursor-pointer">
...
const benefits = [
  {
    ...
    description:
      "Support technology initiatives that directly impact government operations and public services at a national scale.",
    color: "text-rose-500",
    bg: "bg-rose-50",
  ...
  },
  {
    ...
    description:
      "Competitive compensation, benefits packages, and long-term placement opportunities on federal programs.",
    ...
    <Section className="bg-slate-50 border-b border-gray-100">
      ...
      >
        <div className="bg-tg-navy rounded-3xl p-10 md:p-14 relative overflow-hidden">
          ...
          />
          <div className="absolute top-0 right-0 w-64 h-64 bg-tg-blue/20 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="relative z-10 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/careers/jobs">
                <span className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-lg bg-tg-gold text-tg-navy font-bold text-sm hover:bg-yellow-400 transition-all shadow-md cursor-pointer">
                  View Open Positions <ArrowRight className="h-4 w-4" />
                </span>
              </Link>
              <Link href="/careers/submit-resume">
