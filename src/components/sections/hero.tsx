...
export function Hero() {
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-tg-navy text-white min-h-[90vh] flex items-center">
      {/* Abstract Background Elements */}
      <div className="absolute inset-0 z-0 opacity-20">
        <div className="absolute inset-0 bg-grid-pattern" />
        <div className="absolute top-0 right-0 w-200 h-200 bg-tg-blue rounded-full blur-[120px] opacity-40 translate-x-1/3 -translate-y-1/4" />
        <div className="absolute bottom-0 left-0 w-150 h-150 bg-tg-gold rounded-full blur-[150px] opacity-10 -translate-x-1/3 translate-y-1/4" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <motion.div 
            ...
            className="max-w-2xl"
          >
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-sm font-medium text-tg-gold mb-6">
              <span className="flex h-2 w-2 rounded-full bg-tg-gold animate-pulse"></span>
              <span>Trusted Federal Subcontractor</span>
            </div>
            
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.1] mb-6">
              Federal IT Expertise That <span className="text-transparent bg-clip-text bg-linear-to-r from-white to-gray-400">Delivers Results.</span>
            </h1>
            
            <p className="text-lg sm:text-xl text-gray-300 mb-10 leading-relaxed max-w-xl">
              TG Federal provides specialized technology consultants and enterprise IT solutions to U.S. government agencies and prime contractors nationwide.
            </p>
              ...
              <div className="relative w-full h-full max-w-md mx-auto">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-tg-navy border border-tg-gold/50 rounded-full flex items-center justify-center z-20 shadow-[0_0_50px_rgba(212,175,55,0.2)]">
                  <div className="w-24 h-24 bg-linear-to-br from-tg-blue to-tg-navy rounded-full border border-white/10 flex items-center justify-center">
                    <span className="font-bold text-xl text-white tracking-wider">TG</span>
                  </div>
                </div>
                ...
                <svg className="absolute inset-0 w-full h-full animate-[spin_60s_linear_infinite]" viewBox="0 0 400 400">
                  ...
                  <circle cx="200" cy="40" r="6" fill="#D4AF37" className="animate-pulse" />
                  <circle cx="61" cy="280" r="4" fill="#ffffff" />
                  <circle cx="339" cy="280" r="8" fill="#1E3A5F" />
                </svg>

                <svg className="absolute inset-0 w-full h-full animate-[spin_40s_linear_infinite_reverse]" viewBox="0 0 400 400">
                ...
                <div className="absolute top-[10%] right-[10%] bg-white/5 backdrop-blur-sm border border-white/10 p-3 rounded-lg z-30 animate-[bounce_4s_ease-in-out_infinite]">
                  <div className="h-1.5 w-12 bg-tg-gold/70 rounded mb-2"></div>
