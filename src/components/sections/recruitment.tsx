...
export function Recruitment() {
  const benefits = [
    ...
    "Exciting variety of high-impact government and enterprise projects",
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
            EaseOrigin supports consultants throughout their careers with strong partnerships, competitive benefits, and opportunities to work on exciting, mission-critical government and enterprise projects.
          </p>
