  ...
  const solutions = [
    {
      ...
      description: "Expertise in implementing and managing enterprise platforms such as Salesforce, ServiceNow, SAP, and Microsoft Dynamics.",
    },
    {
      icon: Server,
      title: "Cloud & Infrastructure",
      description: "Modern cloud architecture, seamless migrations, infrastructure modernization, and cloud-native application development.",
    },
    {
      icon: Shield,
      title: "Cybersecurity",
      description: "Advanced threat intelligence, compliance (NIST/FISMA), risk management, and securing sensitive federal systems.",
    },
    {
      icon: Database,
      title: "Data & Analytics",
      description: "Data science, predictive business intelligence, and visualization solutions for mission-critical decision making.",
    }
  ];
  ...
  return (
    <Section id="solutions" className="relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('images/federal-building-columns.jpg')`,
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto mb-16">
        <h2 className="text-tg-gold font-semibold tracking-wider uppercase text-sm mb-3">Capabilities</h2>
        <h3 className="text-3xl md:text-4xl font-bold text-tg-navy mb-6">Comprehensive Federal IT Solutions</h3>
        <p className="text-lg text-gray-600">
          We provide specialized technical expertise to solve complex challenges and modernize infrastructure across the federal government.
        </p>
      </div>
        ...
        {solutions.map((solution, index) => (
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <a href="#contact" className="inline-flex items-center text-sm font-semibold text-tg-blue group-hover:text-tg-gold transition-colors duration-300">
